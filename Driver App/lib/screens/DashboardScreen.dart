...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  void init() async {
    ...
    await getAppSetting().then((value) {
      appStore.setWalletPresetTopUpAmount(value.walletSetting!.firstWhere((element) => element.key == "preset_topup_amount").value ?? PRESENT_TOP_UP_AMOUNT_CONST);
      markers.add(
        Marker(
                                  ...
                                  inkWellWidget(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          borderRadius: BorderRadius.circular(defaultRadius)),
                                      child: Text(language.sos, style: boldTextStyle()),
                                    ),
                                  ),
                                  SizedBox(width: 8),
                                  inkWellWidget(
    ...
    return Positioned(
      ...
      child: FlutterSwitch(
        ...
        onToggle: (value) async {
          await showConfirmDialogCustom(dialogType: DialogType.CONFIRMATION, primaryColor: primaryColor, title: isOffLine ? language.areYouCertainOffline : language.areYouCertainOnline, context,
              onAccept: (v) {
