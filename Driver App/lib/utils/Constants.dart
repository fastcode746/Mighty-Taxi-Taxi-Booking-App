...
//region DomainUrl
const DOMAIN_URL = 'YOUR BASE URL'; // Don't add slash at the end of the url
//endregion
...
const MQTT_UNIQUE_TOPIC_NAME = 'YOUR MQTT UNIQUE TOPIC NAME'; // Don't add underscore at the end of the name
//endregion
...
const mOneSignalAppIdDriver = 'DRIVER ONESIGNAL APP KEY';
const mOneSignalRestKeyDriver = 'DRIVER ONESIGNAL REST API KEY';

const mOneSignalAppIdRider = 'RIDER ONESIGNAL KEY';
