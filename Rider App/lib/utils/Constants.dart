...
const GOOGLE_MAP_API_KEY = 'YOUR GOOGLE MAP KEY';
//endregion

//region DomainUrl
const DOMAIN_URL = 'https://apps.meetmighty.com/mighty-taxi'; // Don't add slash at the end of the url
//endregion

//region MQTT port and unique name
final client = MqttServerClient.withPort("broker.hivemq.com", "", 1883);
const MQTT_UNIQUE_TOPIC_NAME = 'YOUR UNIQUE NAME'; // Don't add underscore at the end of the url
//endregion

//region OneSignal Keys
//You have to generate 2 onesignal account one for rider and one for driver
const mOneSignalAppIdDriver = 'DRIVER ONESIGNAL APP ID';
const mOneSignalRestKeyDriver = 'DRIVER ONESIGNAL REST API KEY';

const mOneSignalAppIdRider = 'RIDER ONESIGNAL APP ID';
const mOneSignalRestKeyRider = 'RIDER ONESIGNAL REST API KEY';
//endregion
